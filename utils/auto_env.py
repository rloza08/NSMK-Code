...
def ENTER_ENV_VLANS(agent):
    if agent != "cli-deploy-vlans-add":
        ...
        org_group = settings["CLI"]["networks_org"]
        store_list = settings["CLI"]["networks_store_list"]
    ...
    org_group = settings["CLI"]["vlans_org"]
    store_list = settings["CLI"]["vlans_store_list"]
    return org_group, store_list
