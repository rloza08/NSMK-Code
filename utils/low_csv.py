...
def read_remove_csv_header(csv_fname, csv_fname_out):
    obj=Csv()
    entries = {}
    ...
    with open(csv_fname, encoding="windows-1251", newline='') as csv_file:
        ...
        json_data = []
        with open(csv_fname_out, 'w', newline='') as csvfile:
            writer = csv.DictWriter(csvfile, field_names)
            for entry in entries:
                json_data.append(entry)
...
if __name__ == '__main__':
    ...
    cwd = os.getcwd()
    print (cwd)
    csv_fname = "{}/../../templates/vlans-add-list-v01.csv".format(cwd)
    csv_fname_out = "{}/../../templates/vlans-add-list-v01-append.csv".format(cwd)
    entries = read_remove_csv_header(csv_fname, csv_fname_out)
