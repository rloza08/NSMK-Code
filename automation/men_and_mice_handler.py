#!/usr/bin/env python3
from api.men_and_mice import convert_funnel, convert_funnel_patch,  convert_funnel_vlans_add, convert_funnel_vlans_delete
...
def get_vlans_delete_list(vlans_delete_list):
    ...
    json_funnel_delete_vlans = reader("vlans_delete_list", configDir="runtime")
